...
/**
 * Storage Module manage storage type and install module to your angular application. With web storage, web applications can store data locally within the user's browser.
